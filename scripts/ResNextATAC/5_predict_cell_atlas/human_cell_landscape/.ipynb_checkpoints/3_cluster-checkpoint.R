...
###### load matrix######
mat=Matrix::readMM('pmat_pred_imputed.mtx')
dim(mat)
library(data.table)

peak=fread('/file/path/prefix/pred_peak_hg38_sub_filter_sort_rmdup.bed')
head(peak)
...
obj=FindClusters(obj,resolution = 0.3,algorithm = 3,verbose = F)
