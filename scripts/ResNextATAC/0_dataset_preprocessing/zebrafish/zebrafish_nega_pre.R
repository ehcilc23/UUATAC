...
Convert('./tmp.h5Seurat',dest = './Zebrafish_5wCells_7wPeaks.h5ad',overwrite = T)
...
windows_negative_subset=windows_negative[sample(1215505,37225),]
...
fwrite(as.data.frame(windows_negative_peak),file = './nega_zf.csv')
