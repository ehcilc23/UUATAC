...
SaveH5Seurat(seob,filename = './Mouse_Female.h5Seurat',overwrite = T)
Convert('./Mouse_Female.h5Seurat',dest = './Mouse_Female_5wCells_17wPeaks.h5ad',overwrite = T)
file.remove('./Mouse_Female.h5Seurat')
...
windows_negative_subset=windows_negative[sample(2490825,87919),]
...
fwrite(as.data.frame(windows_negative_subset),file = 'nega_femalemus.csv')
