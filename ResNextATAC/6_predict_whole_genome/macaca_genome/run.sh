#!/bin/bash 
#SBATCH --job-name=UU_pred_macaca
...
python pred_Macaca_chr.py --region Region.*.slide.Macaca.input.txt --anno Female_mus_anno_5w.txt

species_chrom_size=Mfascicularis_6.0.chrom.sizes
