import sys
sys.path.append("/public/home/guogjgroup/ggj/WHY/AI/NvTK_bak/")
...
trainer = Trainer(model, criterion, optimizer, device, 
                    ...
                    use_tensorbord=True)
## reload best model
model = trainer.load_best_model('/public/home/guogjgroup/ggj/WHY/AI/CodeTest/20230822_UU_pred_wholegenome/Log_femalemus/best_model.pth')
model.eval()
...
#anno['lineage'] = anno.anno.apply(lambda x:x.split("_")[0])
